<template>
    <div>
        ...
        <Table :data="teacherData.slice((currentPage-1)*currentSize,currentPage*currentSize)" :columns="studentColumns" stripe border :loading="loading">
